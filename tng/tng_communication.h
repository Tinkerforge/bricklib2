...
#define TNG_FID_GET_TIMESTAMP 234
#define TNG_FID_COPY_FIRMWARE 235
...
} __attribute__((__packed__)) TNGGetTimestamp;

typedef struct {
	TFPMessageHeader header;
    uint64_t timestamp;
} __attribute__((__packed__)) TNGGetTimestamp_Response;
