...
# Then we check if asf is installed in bricklib2
	@if [ ! -d "$(ASFLIB_PATH)" ]; then \
		echo "Could not find xmclib in bricklib2. Please download asf from atmel and symlink it into the bricklib2/ folder."; \
		exit 1; \
	fi
