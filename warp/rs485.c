...
#define rs485_rx_irq_handler  RS485_RX_HANDLER
#define rs485_tx_irq_handler  RS485_TX_HANDLER
...
void rs485_init_hardware(void) {
	...
	XMC_USIC_CH_TXFIFO_Configure(RS485_USIC, RS485_TX_FIFO_POS, RS485_TX_FIFO_LENGTH, RS485_TX_FIFO_LIMIT);

	// Configure receive FIFO
	XMC_USIC_CH_RXFIFO_Configure(RS485_USIC, RS485_RX_FIFO_POS, RS485_RX_FIFO_LENGTH, RS485_RX_FIFO_LIMIT);
